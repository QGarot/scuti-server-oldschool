...
class FloorHeightMapMessageComposer(MessageComposer):
    def __init__(self, model: RoomModel):
        self.response = ServerMessage(src.communication.outgoing.header.FloorHeightMapMessageComposer)
        self.model = model
...
class HeightMapMessageComposer(MessageComposer):
    def __init__(self, model: RoomModel):
        self.response = ServerMessage(src.communication.outgoing.header.HeightMapMessageComposer)
        self.model = model
