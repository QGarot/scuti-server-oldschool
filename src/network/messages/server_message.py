import src.utils.wire_encoding
import src.utils.base_64_encoding
...
class ServerMessage:
    ...
    def append_int32(self, i):
        self.append_bytes(src.utils.wire_encoding.encode_int32(i))
    ...
    def get_bytes(self):
        ...
        buffer2 = src.utils.base_64_encoding.encode_int32(self.message_id, 2)
        buffer[0] = buffer2[0]
        buffer[1] = buffer2[1]
